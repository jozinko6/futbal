...
import {
  ...
  DIFFICULTY_PARAMS, TEAM_COLORS, FIELD_COLORS, FORMATION_121_HOME, TEAM_TACTICS,
...
export { METER_PX, mps, m, MOVEMENT, BALL, DEFENSE, PASSING, SHOOTING, AI_INTERVALS, TEAM_TACTICS };
